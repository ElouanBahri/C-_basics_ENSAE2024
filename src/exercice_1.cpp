...
void PB1() {
    ...
    cout << "Data Type: unsigned int, Size: " << sizeof(unsignedIntVar) << " bytes\n";
    cout << "Data Type: long, Size: " << sizeof(longVar) << " bytes\n";
    cout << "Data Type: unsigned long, Size: " << sizeof(unsignedLongVar) << " bytes\n";
...
void PB2() {
    ...
    for (char c : chars) {
        std::cout << "Character: '" << c << "' has ASCII code: " << static_cast<int>(c) << std::endl;
    }
...
void PB3() {
    ...
    if (inputChar >= 'a' && inputChar <= 'z') {
        ...
        cout << "The upper case character corresponding to '" << inputChar << "' is '" << upperChar << "'.\n";
    }
    // Check if the character is uppercase
    else if (inputChar >= 'A' && inputChar <= 'Z') {
        char lowerChar = inputChar - 'A' + 'a'; // Convert to lowercase
        cout << "The lower case character corresponding to '" << inputChar << "' is '" << lowerChar << "'.\n";
    }
...
void PB4() {
    ...
    cout << "The nearest integer of '" << inputFloat << "' is '" << round(inputFloat) << "'.\n";
